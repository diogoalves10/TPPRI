$(()=>{
    ...
    $("#registerUsernameForm").change(function() {
        ...
        $.ajax({
            ...
            statusCode: {
                200: () => {
                    $(".userNameCheck").remove();
                    $("#registerUsernameForm").after("<img class='userNameCheck' height='30' margin-left='12' src='images/check.png'/>")
                },
                406: () => {
                    $(".userNameCheck").remove();
                    $("#registerUsernameForm").after("<img class='userNameCheck' height='30' margin-left='12' src='images/notcheck.png'/>")
                }
            }
        })
    })

        $("#registerEmailForm").change(function () {
            $(".emailCheck").remove();
            ...
            if(!validateEmail($("#registerEmailForm").val())){
                $("#registerEmailForm").after("<img class='emailCheck' height='30' margin-left='12' src='images/notcheck.png'/>")
                emailok = false;
                return;
            }
            ...
            $.ajax({
                ...
                statusCode: {
                    200: () => {
                        $(".emailCheck").remove();
                        $("#registerEmailForm").after("<img class='emailCheck' height='30' margin-left='12' src='images/check.png'/>")
                    },
                    406: () => {
                        $(".emailCheck").remove();
                        $("#registerEmailForm").after("<img class='emailCheck' height='30' margin-left='12' src='images/notcheck.png'/>")
    ...
    $("#passwordForm").change(function () {
        ...
        if($("#passwordForm").val().length < 4 )
            $("#passwordForm").after("<img class='passwordCheck' height='30' margin-left='12' src='images/notcheck.png'/>")
        else
            $("#passwordForm").after("<img class='passwordCheck' height='30' margin-left='12' src='images/check.png'/>")
    })
